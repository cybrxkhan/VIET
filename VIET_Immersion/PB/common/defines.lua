...
NDiplomacy = {
	...
	BREAK_TRUCE_PRESTIGE_COST = 100,			-- Base Prestige cost for breaking a truce
	...
	JAIN_LIEGE_OPINION_BONUS = 20,				-- Jain Lieges Get Vassal Opinion Bonus
	...
	DEMAND_RELIGIOUS_CONVERSION_INTERACTION_THRESHOLD_FOR_YES = 75,
...
NCharacter = {
	...
	NATURAL_DEATH_CHANCE_AGE_20 = 5,				-- Natural deaths per decade out of 10000 people: Age 20-29
	NATURAL_DEATH_CHANCE_AGE_30 = 10,				-- Natural deaths per decade out of 10000 people: Age 30-39
	...
	NATURAL_DEATH_CHANCE_AGE_70 = 1000,				-- Natural deaths per decade out of 10000 people: Age 70-79
	NATURAL_DEATH_CHANCE_AGE_80 = 2000,				-- Natural deaths per decade out of 10000 people: Age 80-90
	NATURAL_DEATH_CHANCE_AGE_90 = 5000,				-- Natural deaths per decade out of 10000 people: Age 90-99
	NATURAL_DEATH_CHANCE_AGE_100 = 8250,			-- Natural deaths per decade out of 10000 people: Age 100+
...
-- Monthly prestige from vassals
	BARON_AS_VASSAL_PRESTIGE = 0.02,
	COUNT_AS_VASSAL_PRESTIGE = 0.05,
	DUKE_AS_VASSAL_PRESTIGE = 0.2,
	KING_AS_VASSAL_PRESTIGE = 0.8,
...
-- Monthly prestige from held titles
	...
	DUKE_TITLE_PRESTIGE = 0.15,
	KING_TITLE_PRESTIGE = 0.6,
	EMPEROR_TITLE_PRESTIGE = 0.8,
...
-- Title Creation Prestige Gain
	...
	EMPEROR_CREATION_PRESTIGE = 1200,
...
-- Title Destruction Prestige Cost
	...
	EMPEROR_DESTRUCTION_PRESTIGE_COST = 1200,
...
-- Title creation and usurpation requirements	
	...
	EMPIRE_DEJURE_COUNTY_LIMIT_TO_CREATE = 0.75,		-- Fraction of de jure counties that you must control to create an imperial title
...
NReligion = {
	...
	REFORM_RELIGION_MIN_AUTHORITY = 0.7,			-- Moral authority required to reform a pagan faith
	REFORM_RELIGION_MIN_HOLY_SITES = 4,				-- Number of holy sites you must control to reform a pagan faith
	REFORM_RELIGION_PIETY_COST = 2000,				-- Piety cost of reforming a pagan faith
	AUTHORITY_FROM_HOLY_SITE = 0.13,					-- Authority from each holy site held
	...
	DIVINE_BLOOD_FERTILITY_MULT = 0.66,				-- Fertility multiplier in a religious close kin marriage
...
NEconomy = {
	...
	TRADE_POST_COST_INC_DIST = 0.01,				-- The % increase in cost due to distance to closest connected province
	...
	PATRICIAN_CAMPAIGN_FUND_FACTOR = 3,				-- The effect of money in the Campaign Fund on Doge elections (money * factor)
	PATRICIAN_PRESTIGE_RESPECT_FACTOR = 3,			-- The effect of Prestige on the Respect value for Doge elections (prestige * factor)
	PATRICIAN_AGE_RESPECT_FACTOR = 2,				-- The effect of Age on the Respect value for Doge elections (age * age * factor)
	DOGE_SUCC_RANDOM_FACTOR = 700,					-- The random Respect factor on actual Doge succession
...
NMilitary = {
	...
	BATTLE_WARSCORE_WORTH = 125,					-- Warscore from battles are multiplied with this value
	...
	CAPITAL_WARSCORE_MULTIPLIER = 1.2,				-- Warscore multiplier for capital(this is scaled with SETTLEMENT_WARSCORE_MULTIPLIER)
	...
	OWN_SETTLEMENT_SUPPLY_BONUS = 0.4,				-- Extra supply from being in home realm
	...
	COASTAL_SUPPLY_BONUS = 0.3,						-- Supply bonus in coastal provinces
	...
	LEADER_MARTIAL_DAMAGE_BONUS = 0.08,				-- Percentage bonus to damage for each point of martial the flank leader has
	...
	PIKEMEN_PHASE_PURSUE_DEFENSE = 1.5,
...
NAI =
{
	...
	PEACEAI_STALLED_WAR_WARSCORE_MONTHS = 60,				-- Months until total warscore decrease takes full effect(linear)
